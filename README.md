...
<!-- PROJECT DESCRIPTION -->
# 📖 # capstone-project-htmlcss-js <a name="about-project"></a>
...
- Use CSS box model.
- Use Flexbox to place elements on the page.
...
[Project Live Link](https://titus-kiplagat.github.io/capstone-project-htmlcss-js/)
...
```sh
  ...
  git clone git@github.com:Titus-Kiplagat/capstone-project-htmlcss-js.git
  cd capstone-project-htmlcss-js
```
...
- Add more animation and transition
- Create more pages to ensure all link redirection are correct and working
